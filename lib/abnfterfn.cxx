...
public abnf_rule_ri
{
	 ...
	 * Initialized rule.
	 */
	abnf_rule_terfn(const abnf_ruleset& r_set, int (*ter_fn)(int)):
	abnf_rule_ri(r_set),
...
abnf_rule_ri* abnf_rule_terfn::dupl_impl(const abnf_ruleset& r_set,
		map<const abnf_rule*, abnf_rule_ri*>& d_map) const
{
	return new abnf_rule_terfn(r_set, _fn);
}
